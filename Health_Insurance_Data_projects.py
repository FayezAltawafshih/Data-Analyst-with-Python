{
  ...
  "metadata": {
    "colab": {
      ...
      "authorship_tag": "ABX9TyPCQFrxN+rFKs/ZN3GahNnN",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/FayezAltawafshih/Data-Analyst-with-Python/blob/main/Health_Insurance_Data_projects.py\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "code",
      ...
      "metadata": {
        ...
        "id": "rQLhmVS5aKvk",
        "outputId": "89af0f5e-ee81-4e00-81e9-491e41a04aa7"
      },
      "execution_count": 1,
      "outputs": [
        {
    ...
    },
    {
      ...
      "source": [
        ...
        "st.title(config[\"title\"])  # Use \"title\" to access the correct value\n",
        "\n",
      ...
      "metadata": {
        ...
        "id": "LV-oWExTashB",
        "outputId": "5e55c940-557e-48ef-96b7-048dfef53626"
      },
      "execution_count": 2,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "3p2sdaFa4_Ts",
        "outputId": "7b0c5e1b-ff40-4870-eacc-815f72d86510"
      },
      "execution_count": 5,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-b7b234bd-3a72-4d1a-bd73-29f966488fbc\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              ...
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-b7b234bd-3a72-4d1a-bd73-29f966488fbc')\"\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-b7b234bd-3a72-4d1a-bd73-29f966488fbc button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-b7b234bd-3a72-4d1a-bd73-29f966488fbc');\n",
              "        const dataTable =\n",
              ...
              "\n",
              "\n",
              "<div id=\"df-2d3d8db1-4e38-4d4b-b795-da3e42de3869\">\n",
              "  <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-2d3d8db1-4e38-4d4b-b795-da3e42de3869')\"\n",
              ...
              "        document.querySelector('#df-2d3d8db1-4e38-4d4b-b795-da3e42de3869 button');\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "Nkl_W7h-4fFZ",
        "outputId": "df44fbda-b596-4f49-8104-616aa4edbe32"
      },
      "execution_count": 6,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "ai_8hJHn7E3S",
        "outputId": "b2585dc0-44e4-4575-cfc5-6d823aafb669"
      },
      "execution_count": 7,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "jTOFQpWR_NIK",
        "outputId": "4060fd77-3051-4227-a5ac-9c3997514d37"
      },
      "execution_count": 8,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "wbhJJIEE_5Pz",
        "outputId": "6651d8f9-655f-44c8-f86e-7fb515f364fc"
      },
      "execution_count": 9,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-93545070-9f2a-473e-acf9-3ef076fb3abb\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-93545070-9f2a-473e-acf9-3ef076fb3abb')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-93545070-9f2a-473e-acf9-3ef076fb3abb button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-93545070-9f2a-473e-acf9-3ef076fb3abb');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
              ...
              "\n",
              "\n",
              "<div id=\"df-c059b99f-be58-4c0b-87f4-73d4fdcc4fb6\">\n",
              "  <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-c059b99f-be58-4c0b-87f4-73d4fdcc4fb6')\"\n",
              "            title=\"Suggest charts\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "    (() => {\n",
              "      let quickchartButtonEl =\n",
              "        document.querySelector('#df-c059b99f-be58-4c0b-87f4-73d4fdcc4fb6 button');\n",
              "      quickchartButtonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "    })();\n",
              "  </script>\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "zRDRQUEf7keL",
        "outputId": "fbbe0234-0ee2-4f00-d2a8-a4838de979f4"
      },
      "execution_count": 10,
      "outputs": [
        {
          ...
          "name": "stderr",
          "text": [
            "<ipython-input-10-45f6d2dc5c10>:4: UserWarning: \n",
            "\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "g2O1s4w7B2tC",
        "outputId": "6c4a3bc3-ee85-4193-b9fa-cf92eef979ca"
      },
      "execution_count": 11,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "ifzpn6YJCrn5",
        "outputId": "adc58d4c-0861-4ba5-e8a3-8e010eecaf14"
      },
      "execution_count": 12,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "outputId": "6c077913-9ebb-49cc-efc6-80cbad6f2cf5"
      },
      "execution_count": 13,
      "outputs": [
        {
          ...
          "name": "stderr",
          "text": [
            "<ipython-input-13-a971c9a2c426>:3: UserWarning: \n",
            "\n",
            "`distplot` is a deprecated function and will be removed in seaborn v0.14.0.\n",
            "\n",
            "Please adapt your code to use either `displot` (a figure-level function with\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "iNoii-6jXd8X",
        "outputId": "3763b421-5a11-47e0-c604-8f7cc44a765f"
      },
      "execution_count": 14,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "Vtv7t-SIY8Z1",
        "outputId": "0d39a13d-49fb-49a7-f3cb-9031b4b20ffa"
      },
      "execution_count": 15,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "1Tpn9ALJZRsJ",
        "outputId": "df43ec71-f2af-49a3-f114-75125a9f3301"
      },
      "execution_count": 16,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "8HEFBgQEbAQf",
        "outputId": "37d7a8b3-f8bb-4eeb-a057-7ad161c1a9cc"
      },
      "execution_count": 17,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "O4uhHYCtb4O5",
        "outputId": "671f02c1-8aec-49c7-f762-800068cdc44f"
      },
      "execution_count": 18,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "2i0zlMupedID",
        "outputId": "da8e375b-8421-4822-bca9-28161363aee9"
      },
      "execution_count": 19,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "x3LJvz4Hehy-",
        "outputId": "febb1336-0c48-4a36-8304-69b6939fe260"
      },
      "execution_count": 20,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "UnKd-px5gN7h",
        "outputId": "99e77514-d7a1-4b55-8ec2-0f05842631dd"
      },
      "execution_count": 22,
      "outputs": [
        {
          ...
          "data": {
            ...
            "text/html": [
              "\n",
              "  <div id=\"df-00cdb23d-8e2f-466d-b46c-f69494dbe8f1\" class=\"colab-df-container\">\n",
              "    <div>\n",
              "<style scoped>\n",
              "    .dataframe tbody tr th:only-of-type {\n",
              "        vertical-align: middle;\n",
              ...
              "\n",
              "  <div class=\"colab-df-container\">\n",
              "    <button class=\"colab-df-convert\" onclick=\"convertToInteractive('df-00cdb23d-8e2f-466d-b46c-f69494dbe8f1')\"\n",
              "            title=\"Convert this dataframe to an interactive table.\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "  <svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\" viewBox=\"0 -960 960 960\">\n",
              ...
              "    <script>\n",
              "      const buttonEl =\n",
              "        document.querySelector('#df-00cdb23d-8e2f-466d-b46c-f69494dbe8f1 button.colab-df-convert');\n",
              "      buttonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "\n",
              "      async function convertToInteractive(key) {\n",
              "        const element = document.querySelector('#df-00cdb23d-8e2f-466d-b46c-f69494dbe8f1');\n",
              "        const dataTable =\n",
              "          await google.colab.kernel.invokeFunction('convertToInteractive',\n",
              "                                                    [key], {});\n",
              "        if (!dataTable) return;\n",
              ...
              "\n",
              "\n",
              "<div id=\"df-cef6b3c3-8e6b-4197-8ee8-9d11bf6d0b7a\">\n",
              "  <button class=\"colab-df-quickchart\" onclick=\"quickchart('df-cef6b3c3-8e6b-4197-8ee8-9d11bf6d0b7a')\"\n",
              "            title=\"Suggest charts\"\n",
              "            style=\"display:none;\">\n",
              "\n",
              "<svg xmlns=\"http://www.w3.org/2000/svg\" height=\"24px\"viewBox=\"0 0 24 24\"\n",
              ...
              "    (() => {\n",
              "      let quickchartButtonEl =\n",
              "        document.querySelector('#df-cef6b3c3-8e6b-4197-8ee8-9d11bf6d0b7a button');\n",
              "      quickchartButtonEl.style.display =\n",
              "        google.colab.kernel.accessAllowed ? 'block' : 'none';\n",
              "    })();\n",
              "  </script>\n",
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "zHIlhjcifKYq",
        "outputId": "201bee16-c2c7-4d20-b2ed-96d2cf10ac95"
      },
      "execution_count": 24,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "ePV98TWLmhob",
        "outputId": "c12e9bba-1060-49de-b4b7-e034118f2da1"
      },
      "execution_count": 25,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "w_Dx792DmjBJ",
        "outputId": "2452a4b2-b519-4e99-de3b-bc6eb00d5537"
      },
      "execution_count": 27,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "cSCoAytDoWRT",
        "outputId": "cf514100-1fdd-4476-daf3-0a951b928fb0"
      },
      "execution_count": 29,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "EGsF3TBbtKYL",
        "outputId": "fb7907b6-deaa-41d6-ddba-e7b4f1d24544"
      },
      "execution_count": 31,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "rDEEBb7MvDh-",
        "outputId": "15a1df59-b090-491b-da15-c7e379f2c14c"
      },
      "execution_count": 33,
      "outputs": [
        {
    ...
    },
    {
      ...
      "metadata": {
        ...
        "id": "CXH0rT5rxs3D",
        "outputId": "0319cd0f-ecb2-4b97-a333-14c1814d5977"
      },
      "execution_count": 34,
      "outputs": [
        {
